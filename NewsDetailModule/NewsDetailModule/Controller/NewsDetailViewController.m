...
//                    [_tableNode reloadSection:indexPath.section withRowAnimation:UITableViewRowAnimationNone];
        ...
        case 2:
        {
            ...
            NewsDetailRelativeCellNode *cellNode = [NewsDetailRelativeCellNode cellWithTableView:tableView];
...
{
    NewsDetailSectionTitleHeader *headerView = [NewsDetailSectionTitleHeader sectionHeaderWithTableView:tableView];
    switch (section) {
        case 1:
        {
...
{
    NewsDetailSectionCommentFooter *footerView = [NewsDetailSectionCommentFooter sectionFooterWithTableView:tableView];
    if (1 == section) {
        if (_detailModel.tie.comments.count > 0) {
