//
//  NewsDetailSectionTitleHeader.m
//  NewsDetailModule
//
...
@interface NewsDetailSectionTitleHeader ()
//UI
...
@implementation NewsDetailSectionTitleHeader

+ (instancetype)sectionHeaderWithTableView:(UITableView *)tableView
{
    static NSString *ID = @"NewsDetailSectionTitleHeader";
    NewsDetailSectionTitleHeader *header = [tableView dequeueReusableHeaderFooterViewWithIdentifier:ID];
    if (header == nil) {
        header = [[NewsDetailSectionTitleHeader alloc] initWithReuseIdentifier:ID];
    }
    return header;
}
