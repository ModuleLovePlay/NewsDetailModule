...
@interface NewsDetailRelativeCellNode ()
//UI
...
@implementation NewsDetailRelativeCellNode

+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    static NSString *ID = @"NewsDetailRelativeCellNode";
    NewsDetailRelativeCellNode *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[NewsDetailRelativeCellNode alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return cell;
}
