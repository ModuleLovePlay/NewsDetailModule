...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is NewsDetailModule
                   DESC

  s.homepage     = "https://github.com/ModuleLovePlay/NewsDetailModule"
  ...
  s.source       = { :git => "https://github.com/ModuleLovePlay/NewsDetailModul.git", :tag => s.version.to_s }
  ...
  # s.source_files  = "NewsDetailModule/NewsDetailModule/**/*.{h,m}"
  ...
  s.subspec 'View' do |ss|
    ss.source_files = 'NewsDetailModule/NewsDetailModule/View/*.{h,m}'
  ...
  s.subspec 'Controller' do |ss|
    ss.source_files = 'NewsDetailModule/NewsDetailModule/Controller/*.{h,m}'
